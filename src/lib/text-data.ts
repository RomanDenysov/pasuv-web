export const textData = {
	homepage: {
		hero: {
			title: "Kvalifikovaní a skúsení pracovníci pre vaše projekty",
			content:
		...
		referencie: {
			elements: {
				subtitle: "Referencie",
				button: "Ďalšie úspešné projekty",
			},
			content: {
				title: "Našou vizitkou sú spokojní partneri",
				content:
					"V našom portfóliu nájdete priemyselné haly, byty, apartmány, hotely, školy a komerčné budovy. Prijmeme aj tie najnáročnejšie výzvy a stavebné projekty.",
			},
			accordion: [
				{
					id: 1,
...
export const footerData = {
	...
	section3: {
		item1: {
			city: "Praha",
			address: "Ulica 00000/00 Mesto Krajina",
			button: "Zobraziť na mape",
		},
		item2: {
			city: "Prešov",
			address: "Ulica 00000/00 Mesto Krajina",
